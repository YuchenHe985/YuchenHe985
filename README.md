...
| Project | What it is |
| --- | --- |
| [radixgates](https://github.com/YuchenHe985/radixgates) | Go gateway for multi-GPU LLM serving on SGLang, upgraded with prefix-affinity routing, health-aware failover, circuit breaking, admission control and a failure-injection benchmark against the original, and tests against real llama.cpp workers; includes my 4x RTX 4090 / 4x A100 evaluation. |
...
| [llm-finetune-lab](https://github.com/YuchenHe985/llm-finetune-lab) | Feasibility study of an on-device text-to-SQL assistant: LoRA fine-tuning with PyTorch DDP, evaluation by executing the generated SQL, and guardrails against answers that run but are wrong (16% of answers), ending in a ship or do-not-ship recommendation. |
